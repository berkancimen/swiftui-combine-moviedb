...
class Movie_Filtering_Tests: XCTestCase {
    ...
    func test_filtering_movie_with_genre() {
    ...
    func test_filtering_movie_with_rating_above7() {
    ...
    func test_filtering_movie_with_rating_between5_7() {
    ...
    func test_filtering_movie_with_rating_below5() {
