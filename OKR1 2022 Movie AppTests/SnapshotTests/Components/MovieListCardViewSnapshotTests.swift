//
//  MovieListCardViewSnapshotTests.swift
...
final class MovieListCardViewSnapshotTests: XCTestCase {

    func test_movie_list_card_view() {
        let cardView = MovieListCardView(movie: MovieViewModel.default)
